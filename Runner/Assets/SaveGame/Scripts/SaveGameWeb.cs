...
using William.SaveGame.Encoders;
using William.SaveGame.Serializers;

namespace William.SaveGame
{
	...
	public class SaveGameWeb
	{
		...
		/// <summary>
		/// Gets or sets a value indicating whether this <see cref="William.SaveGameFree.SaveGameWeb"/> default encode.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="William.SaveGameFree.SaveGameWeb"/> class.
		/// </summary>
